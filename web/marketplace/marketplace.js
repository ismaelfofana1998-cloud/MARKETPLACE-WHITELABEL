import { messageErreur, rafraichirIcones } from "../assets/api.js?v=15";
import { rendreAdmin } from "./admin.js?v=15";
import { rendreCompte } from "./account.js?v=15";
import { rendreMarchand } from "./merchant.js?v=15";
import { initialiser, verifierConfiguration, app, vide } from "./shared.js?v=15";
import { rendreAccueil, rendreCheckout, rendrePanier, rendreProduit } from "./storefront.js?v=15";
